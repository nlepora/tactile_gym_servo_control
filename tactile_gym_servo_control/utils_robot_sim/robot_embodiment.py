...
class RobotEmbodiment(Robot):
    ...
    def get_tcp_pose(self):
        """
        Returns pose of the Tool Center Point in work frame
        """
        (
                cur_TCP_pos,
                cur_TCP_rpy,
    ...
    def get_tcp_pose_worldframe(self):
        """
        Returns pose of the Tool Center Point in worldframe
        """
        (
                cur_TCP_pos,
                cur_TCP_rpy,
    ...
    def set_workframe(self, pose):
        """
        Sets the workframe of the robot
        """
        pose *= POSE_UNITS
        self.arm.set_workframe(pose[:3], pose[3:])
